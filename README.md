...
|---|---|---|---|
| 👤 **Employee** | `employee@demo.com` | `demo1234` | My Goals, Check-ins, Progress |
| 👥 **Manager** | `manager@demo.com` | `demo1234` | Team Approvals, Check-in Review |
| 🛡️ **Admin** | `admin@demo.com` | `demo1234` | Full platform access |
